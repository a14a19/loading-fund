...
const Header = () => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", padding: "0px 24px 8px" }}>
            <div style={{ flexGrow: 1 }} />
            <img src={fundLogo} alt="loading_fund" height={"60px"} width={"60px"} style={{ marginLeft: "7vw" }}/>
            <div style={{ flexGrow: 1 }} />
            ...
            {menuClassName &&
                <div onMouseLeave={mouseOut}>
                    <Drawer placement={"right"} size={"sm"} isOpen={menuClassName}>
                        <DrawerContent style={{ borderRadius: "4px", color: "black", margin: "24px 24px 0px 0px", width: "30vw", height: "fit-content", backgroundColor: "#fa4c14" }}>
                            ...
                            <div style={{ width: "100%", display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
                                ...
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>00</span> HOME</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>01</span> ABOUT</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>02</span> RESEARCH</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>03</span> TEAM</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>04</span> PORTFOLIO</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li className="menu_list_item"><span style={{ fontFamily: "'DotGothic16', serif", paddingRight: "16px" }}>05</span> CAREERS</li>
                                <div className="dotted_horizontal_ruler"/>
                                <li>
